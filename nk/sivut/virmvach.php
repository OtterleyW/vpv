<? $an = ArvonimiKasittelija::findOne($db, "1")?>

<h2> <?=$an->nimi?> (<?=$an->lyhenne?>)</h2>
<p>
	Listalta löytyy kaikki VIR MVA Ch -arvonimen ansainneet puoliveriset listattuna roduttain omissa rotukohtaisissa linkeissä. Jos rotua ei löydy listalta, yksikään rodun yksilö ei ole vielä ansainnut VIR MVA Ch -arvonimeä.
</p>
<?
